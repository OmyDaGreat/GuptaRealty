...
import xyz.malefic.guptarealty.client.api.getAssetList
import xyz.malefic.guptarealty.client.api.uploadAsset
                        ...
                        Column(
                            ...
                            Box(Modifier.fillMaxWidth().aspectRatio(1f)) {
                                Image(
                                    url,
                                    fileName,
                                    Modifier.fillMaxSize().objectFit(ObjectFit.Cover).borderRadius(4.px),
                                )
                            }
                            P(
                                LabelSmStyle
